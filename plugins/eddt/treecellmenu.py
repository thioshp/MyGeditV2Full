...
from internationalization import err0005, menu0001, menu0003, menu0007, \
                                 menu0008, menu0009, menu0010, menu0011, \
                                 menu0002
import files
...
class TreeCellMenu(gtk.Menu):
    ...
    def __init__(self, project_explorer):
        ...
        @param project_explorer: the ProjectExplorer the widget should be
            associated with.
        @type project_explorer: a ProjectExplorer
        
        @raise ValueError: if the param ProjectExplorer is None
